export default function ElephantIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill="#F9B54C"
        d="M92.4,450c44,36.4,100,58,161.6,58s117.6-21.6,161.6-58H92.4z"
      />
      <path
        fill="#2B3B4E"
        d="M187.6,239.2c0,0,14.8,74.8,11.6,97.6c0,0-14.4,13.6-1.6,19.6l27.6-1.6c0,0,6-118.8-10.8-126.4
   C197.2,220.8,187.6,239.2,187.6,239.2z"
      />
      <path
        fill="#324A5E"
        d="M142.4,300.4c0,0,12,0,9.6-23.6c0,0,42-36.8,59.6-36c0,0,16.8,80,6,104.4c0,0-11.2,23.2,11.2,17.2
   ...
   c0,0-34.4-2.4-40,18.8c0,0,0.8,32.8,5.6,36.8c0,0,10.8,2.4,16.4-14l35.2-5.2c0,0-21.6,15.2-10.4,24.8L142.4,300.4z"
      />
      <circle fill="#2B3B4E" cx="399.6" cy="229.6" r="6" />
      <path
        fill="#E6E9EE"
        d="M349.2,197.6c2-14.8-2.4-30-1.6-45.2c0.4-4.4,0.8-9.2,3.2-13.2c4.4-9.2,14.8-15.6,24.8-15.6
   ...
   c-7.2,0-12.4-7.6-13.6-11.6c-1.6-4.4-2.4-10,0.8-13.2c2.4-2.4,14.8-11.6,16-16.4C348,201.2,348.8,199.6,349.2,197.6z"
      ...
      <g>
        <path
          fill="#2B3B4E"
          d="M247.2,192c10-9.6,20.8-19.6,24-33.2c-8.4,7.6-16,16-23.6,24.8c7.6-10.8,15.6-22.4,17.6-35.6
       ...
       C269.2,166.4,254.8,186,247.2,192z"
        ...
        <path
          fill="#2B3B4E"
          d="M232.8,212.8c0,0,6.8,15.6-21.2,28C211.6,240.8,238.4,235.6,232.8,212.8z"
        />
      </g>
      <g>
        <path
          fill="#FF7058"
          d="M170,368.4h140.4c4.8,0,8.4-3.6,8.4-8s-4-8-8.4-8H170c-4.8,0-8.4,3.6-8.4,8S165.2,368.4,170,368.4z"
        />
        <path
          fill="#FF7058"
          d="M310.4,435.2H170c-4.8,0-8.4,3.6-8.4,8s4,8,8.4,8h140.4c4.8,0,8.4-3.6,8.4-8
       S315.2,435.2,310.4,435.2z"
        />
      </g>
      <rect x="170" y="368.4" fill="#E6E9EE" width="140.4" height="66.8" />
      <path
        fill="#54C0EB"
        d="M304.8,442L284,360.4c-0.4-0.8-1.2-1.6-2.4-1.6c-1.2,0-2,0.8-2.4,1.6l-18.4,72.4l-18.4-72.4
   ...
   l0,0l0,0c0,0,0,0,0-0.4l0,0l18.4-72.4l18.4,72.4c0.4,2.4,2.8,1.6,2.8,1.6C304.4,444.4,305.2,443.2,304.8,442z"
      ...
      <path
        fill="#324A5E"
        d="M85.2,126.4c0,0-12.4,22.8-12.4,46.8c0,0,15.6-44,22.4-42L85.2,126.4z"
      />
    </svg>
  );
}
